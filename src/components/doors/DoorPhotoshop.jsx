...
const DoorPhotoshop = () => {
  const { nodes, materials } = useGLTF("doors/door-photoshop-v2.glb");
  ...
  return (
    <group ref={doorRef} scale={[2.2, 2.2, 2.2]} position={[0, 0.3, 0]}>
      <mesh
        ...
        receiveShadow
      />
      <mesh ref={frameRef} geometry={nodes.Cube001.geometry} material={materials.frameTexture} />
    </group>
  );
};

export default DoorPhotoshop;
