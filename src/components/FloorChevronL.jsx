...
const FloorChevronL = () => {
  const { nodes, materials } = useGLTF("plank/chevron-L-transformed.glb");
  const geometry = nodes.Cube015.geometry;
      ...
      for (let i = 0; i < 50; i++) {
        instances.push(
          <Instance
            ...
            position={[4.46852 + 17.8741 * index, 20, 2.95902 * i]}
            rotation={[0, 0.663225, 0]}
          />
        );
        instances.push(
          <Instance
